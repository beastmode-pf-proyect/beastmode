...
//           style={{ backgroundImage: "url('/images/goalsimg.png')" }}
//         ></div>
//         {/* Imagen para tablets */}
//         <div
...
//           style={{
//             backgroundImage: "url('/images/goalsimg.png')",
//           }}
//         ></div>
...
//           </p>
//           <button className="bg-red-900 hover:bg-red-800 text-white px-8 py-3 rounded-full text-lg font-semibold transition-colors">
//             Empieza Hoy
//           </button>
//         </div>
//       </div>
